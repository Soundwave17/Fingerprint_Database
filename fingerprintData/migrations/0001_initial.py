# Generated by Django 2.2.3 on 2019-07-29 09:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Fingerprint',
            fields=[
                ('fingerprint_id', models.PositiveIntegerField(primary_key=True, serialize=False, validators=[fingerprintData.models.validate_nonzero])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('product_price', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ...
                ('product_description', models.TextField(default='New product!', max_length=200)),
                ('product_image', models.ImageField(default='fingerprint/static/vendor/img/no-img.jpg', upload_to='fingerprint/static/vendor/img/')),
            ],
        ),
        migrations.CreateModel(
            name='Purchase',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_description', models.CharField(max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseList',
